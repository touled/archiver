...
public class App 
{
    public static void main( String[] args ) throws Exception
    {
        ...
        if (System.in.available() > 0)
            ...
            System.out.println("Archiver. Simple Zip archiver. Compresses and extracts files and folders using ZIP compression algorithm. Usage:\n" +
                    ...
                    "Files and folders will be extracted into the current directory. Files and folders with the same name will be overwritten.\n" +
